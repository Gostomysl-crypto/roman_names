...
class Player:
    ...
    @property
    def lvl(self):
        return self.__lvl, f'{dt.now() - self.__born}'  # чтобы перевести время в строковый вариант
        # - перед функцией ставим f'{сюда запихиваем функцию}'
    ...
    @classmethod  # клас-метод нужен, чтобы действовать не с экземплярами класа, а с класом
